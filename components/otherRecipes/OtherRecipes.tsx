              ...
              <div className="w-full mt-5 ">
                  <div className="w-full h-32  overflow-hidden  p-2 flex flex-row">
                      <div className="w-44 h-28 overflow-hidden rounded-xl">
                          <img src="/recipe2/image2.png" alt="" className="w-full object-cover h-full" />
                      </div>
                  ...
                  <div className="w-full h-32  overflow-hidden  p-2 flex flex-row">
                      <div className="w-44 h-28 overflow-hidden rounded-xl">
                          <img src="/recipe2/image1.png" alt="" className="w-full object-cover h-full" />
                      </div>
                      <div className="w-48 h-28 ml-8 flex flex-col justify-between">
                  ...
                  <div className="w-full h-32  overflow-hidden  p-2 flex flex-row">
                      <div className="w-44 h-28 overflow-hidden rounded-xl">
                          <img src="/recipe2/image5.png" alt="" className="w-full object-cover h-full" />
                      </div>
                      <div className="w-48 h-28 ml-8 flex flex-col justify-between">
